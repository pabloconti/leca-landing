  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "bg-corte" : "url('/corteyconfeccion1.png')",
        "bg-terminado" : "url('/productoterminado1.png')",
        "bg-estampados" : "url('/estampados1.png')",
        "bg-bordados" : "url('/bordados2.png')",
        ...
        "bg-mapa" : "url('/mapa.png')",
        "bg-homeLg" : "url('/homeLg.png')",
        "bg-line" : "url('/line.png')",
